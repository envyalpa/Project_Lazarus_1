...
<div
  class="hero-wrapper"
  class:dismissing
  onkeydown={(e) => { if (e.key === 'Escape') handleEdit(); }}
>
  <div
    class="hero-bg"
  ...
  <div class="hero-content">
    <div class="hero-top-bar">
      <button type="button" class="hero-icon-btn" onclick={handleEdit} title="Back">
        <ArrowLeft size={18} />
      </button>
      <button type="button" class="hero-icon-btn" onclick={handleEdit} title="Close">
        <X size={18} />
      </button>
    </div>
